...
std::string printInfo(const logic::Entity toPrint){
    ...
    toReturn.append(" (");
    toReturn.append(std::to_string(logic::RadiansToDegrees(toPrint.get_horizontal_look_angle())));
    toReturn.append(" degrees) ");
    toReturn.append(" LookAngY: ");
    toReturn.append(" (");
    toReturn.append(std::to_string(logic::RadiansToDegrees(toPrint.get_vertical_look_angle())));
    toReturn.append(" degrees) ");
...
TEST(EntityTest, Look_X_Positive){
    ...
    EXPECT_TRUE(a.get_horizontal_look_angle() == logic::DegreesToRadians(45) && a.get_vertical_look_angle() == 0.0) << "Entity should be looking at " << logic::DegreesToRadians(45) <<" radians on X. \n Entity: " << printInfo(a);
}
...
TEST(EntityTest, Look_Y_Positive){
    ...
    EXPECT_TRUE(a.get_horizontal_look_angle() == 0.0 && a.get_vertical_look_angle() == logic::DegreesToRadians(45)) << "Entity should be looking at " << logic::DegreesToRadians(45) <<" radians on Y. \n Entity: " << printInfo(a);
}
...
TEST(EntityTest, Look_Y_Bounded_Positive){
    ...
    EXPECT_TRUE(ent->get_vertical_look_angle() == logic::DegreesToRadians(90)) << "Entities don't have their look angY bounded positively to 90 degrees";
    delete ent;
}
...
TEST(EntityTest,Children_Move_And_Rotate_X_Pos){
    ...
    logic::Entity* b = new logic::Entity(0,0,0,100,100,100);
    a->AddChild(b,10,0,0);
    a->set_look(logic::DegreesToRadians(45),0);
    a->DoMove(10,10,10);
