...
logic::Map box(int multiplier){
    ...
    game_engine::logic::Entity stair = game_engine::logic::Entity(0,half_player_height/10,0,half_floor_size,player_height/10,half_floor_size);
    // Players
    ...
    // Vectors
    std::vector<game_engine::logic::Entity> level = {floor, roof, northWall, southWall, westWall, eastWall,stair};
